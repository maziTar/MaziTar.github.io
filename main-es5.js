(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                { path: _shared_models_routing_models__WEBPACK_IMPORTED_MODULE_3__["RoutingPath"].DEFAULT, redirectTo: _shared_models_routing_models__WEBPACK_IMPORTED_MODULE_3__["RoutingPath"].WEATHER, pathMatch: 'full' },
                {
                    ...
                    loadChildren: function () { return Promise.all(/*! import() | weather-weather-module */ [__webpack_require__.e("common"), __webpack_require__.e("weather-weather-module")]).then(__webpack_require__.bind(null, /*! ./weather/weather.module */ "./src/app/weather/weather.module.ts")).then(function (m) { return m.WeatherModule; }); },
                },
                {
                    path: _shared_models_routing_models__WEBPACK_IMPORTED_MODULE_3__["RoutingPath"].FAVORITES,
                    loadChildren: function () { return Promise.all(/*! import() | favorites-favorites-module */ [__webpack_require__.e("common"), __webpack_require__.e("favorites-favorites-module")]).then(__webpack_require__.bind(null, /*! ./favorites/favorites.module */ "./src/app/favorites/favorites.module.ts")).then(function (m) { return m.FavoritesModule; }); },
                },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var providers = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].production ? prodProviders : devProviders;
            ...
            var MockBackendInterceptor = /** @class */ (function () {
                ...
                MockBackendInterceptor.prototype.intercept = function (request, next) {
                    ...
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null)
                        ...
                        if (request.url.includes(_this.apiAutocompleteNamespace) && request.method === 'GET') {
                            return _this.getApiCall(request, next, 'GetAccuweatherAutocomplete');
                        }
                        else if (request.url.includes(_this.apiConditionsNamespace) && request.method === 'GET') {
                            return _this.getApiCall(request, next, 'GetAccuweatherCurrentConditions');
                        }
                        else if (request.url.includes(_this.apiForecastNamespace) && request.method === 'GET') {
                            return _this.getApiCall(request, next, 'GetAccuweather5DaysOfForecast');
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DEFAULT_APP_ERROR_TYPE = 9999;
            var AppErrorsTranslationMapping = {
            ...
            var AppError = /** @class */ (function () {
                function AppError(_a) {
                    var _b = _a.status, status = _b === void 0 ? DEFAULT_APP_ERROR_TYPE : _b, error = _a.error;
                    this.status = status;
                    this.value = error;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ApiErrorNormalizationInterceptor = /** @class */ (function () {
                function ApiErrorNormalizationInterceptor() {
                }
                ApiErrorNormalizationInterceptor.prototype.intercept = function (request, next) {
                    var _this = this;
                    return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
                        if (!(response.body)) {
                            // Error
                            throw (new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpErrorResponse"]({ error: response.body }));
                        }
                        return response;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (e) { return _this.normalizeError(e); }));
                };
                ApiErrorNormalizationInterceptor.prototype.normalizeError = function (event) {
                    ...
                    var _errorMessage = event.error.message || event.statusText;
                    var status = event && event.status ? event.status : event.error;
                    ...
                    return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["throwError"])(new _models_error_model__WEBPACK_IMPORTED_MODULE_5__["AppError"]({ status: status, error: _errorMessage }));
                };
                return ApiErrorNormalizationInterceptor;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HttpService = /** @class */ (function () {
                ...
                HttpService.prototype.get = function (url, options) {
                    var requestOptions = this.createRequestOptions(options, 'GET');
                ...
                HttpService.prototype.post = function (url, body, options) {
                    var requestOptions = this.createRequestOptions(options, 'POST');
                    return this.httpClient.post("" + url, body, requestOptions)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(this.handleResponse), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
                };
                HttpService.prototype.put = function (url, body, options) {
                    var requestOptions = this.createRequestOptions(options, 'PUT');
                ...
                HttpService.prototype.delete = function (url, options) {
                    var _this = this;
                    var requestOptions = this.createRequestOptions(options, 'DELETE');
                    return this.httpClient.delete("" + url, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
                        return _this.handleDeleteResponse(res['body']);
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
                };
                HttpService.prototype.createRequestOptions = function (options, method) {
                    ...
                    if (options && options.params) {
                        ...
                        Object.keys(options.params).map(function (key) { return params = params.set(key, options.params[key]); });
                    }
                    var observe = 'response';
                    var withCredentials = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].production; // needs to be false in order to see the data from the server
                    return Object.assign({}, options, { headers: headers,
                        params: params,
                        observe: observe,
                        withCredentials: withCredentials // Add cookies to each api call
                    });
                };
                HttpService.prototype.headersOfType = function (headers, contentType) {
                 ...
                 */
                HttpService.prototype.handleDeleteResponse = function (response) {
                 ...
                 */
                HttpService.prototype.handleResponse = function (response) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToasterInterceptorService = /** @class */ (function () {
                function ToasterInterceptorService(snackBar) {
                    this.snackBar = snackBar;
                }
                ToasterInterceptorService.prototype.intercept = function (req, next) {
                    var _this = this;
                    return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (e) { return _this.handleError(e); }));
                };
                ToasterInterceptorService.prototype.handleError = function (req) {
                ...
                ToasterInterceptorService.prototype.showSnackbar = function (massage) {
                ...
                return ToasterInterceptorService;
            }());
            ToasterInterceptorService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfirmDialogComponent = /** @class */ (function () {
                ...
                ConfirmDialogComponent.prototype.emitAction = function (buttonAction) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ACCUWEATHER_API_AUTOCOMPLETE_URL = 'locations/v1/cities/autocomplete';
            var ACCUWEATHER_API_CONDITIONS_URL = 'currentconditions/v1';
            var ACCUWEATHER_API_5DAYS_OF_FORECASTS_URL = 'forecasts/v1/daily/5day';
            var ACCUWEATHER_API_ICONS_URL = 'https://developer.accuweather.com/sites/default/files/';
            var ACCUWEATHER_API_ICONS_URL_END = '-s.png';
            var ACCUWEATHER_API_DEFAULT_AUTOCOMPLETE_SEARCH = {
                key: '215854',
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            // Autocomplete
            var ACCUWeatherAutocompleteViewModel = /** @class */ (function () {
                function ACCUWeatherAutocompleteViewModel(data) {
                    this.key = data.Key;
                    this.localizedName = data.LocalizedName;
                }
                return ACCUWeatherAutocompleteViewModel;
            }());
            var ACCUWeatherAutocompleteResultsViewModel = /** @class */ (function () {
                function ACCUWeatherAutocompleteResultsViewModel(data) {
                    this.autocompleteResults = [];
                    this.autocompleteResults = this.generateResults(data);
                }
                ACCUWeatherAutocompleteResultsViewModel.prototype.generateResults = function (rawData) {
                    return rawData.reduce(function (prev, current) {
                        if (prev === void 0) { prev = []; }
                        return !prev.length ? [new ACCUWeatherAutocompleteViewModel(current)] : prev.concat([new ACCUWeatherAutocompleteViewModel(current)]);
                    }, []);
                };
                return ACCUWeatherAutocompleteResultsViewModel;
            }());
            // current conditions
            var CurrentConditionsViewModel = /** @class */ (function () {
                function CurrentConditionsViewModel(data) {
            ...
            var FiveDaysOfForecastViewModel = /** @class */ (function () {
                function FiveDaysOfForecastViewModel(data) {
                    this.forecasts = [];
                    this.forecasts = this.generateForecasts(data.DailyForecasts);
                }
                FiveDaysOfForecastViewModel.prototype.generateForecasts = function (rawData) {
                    return rawData.reduce(function (prev, current) {
                        if (prev === void 0) { prev = []; }
                        return !prev.length ? [new DailyForecastViewModel(current)] : prev.concat([new DailyForecastViewModel(current)]);
                    }, []);
                };
                return FiveDaysOfForecastViewModel;
            }());
            var DailyForecastViewModel = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WeatherApiService = /** @class */ (function () {
                ...
                WeatherApiService.prototype.getAutocompleteResults = function (query) {
                    var url = this.apiBaseUrlNamespace + "/" + this.apiAutocompleteNamespace;
                ...
                WeatherApiService.prototype.getCurrentConditions = function (locationKey) {
                    var url = this.apiBaseUrlNamespace + "/" + this.apiConditionsNamespace + "/" + locationKey;
                    return this.http.get(url, {
                        params: {
                            language: 'en-us',
                            apikey: this.apiKeyNamespace,
                ...
                WeatherApiService.prototype.get5DaysOfDailyForecasts = function (locationKey) {
                    var url = this.apiBaseUrlNamespace + "/" + this.apiForecastNamespace + "/" + locationKey;
                    return this.http.get(url, {
                        params: {
                            language: 'en-us',
                            apikey: this.apiKeyNamespace,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WeatherService = /** @class */ (function () {
                ...
                WeatherService.prototype.getAutocompleteResults = function (query) {
                    return this.weatherApiService.getAutocompleteResults(query).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.data; }));
                };
                WeatherService.prototype.getCurrentSelectedPlaceForecast = function (locationKey) {
                    return this.weatherApiService.getCurrentConditions(locationKey).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.data[0]; }));
                };
                WeatherService.prototype.get5DaysOfDailyForecasts = function (locationKey) {
                    return this.weatherApiService.get5DaysOfDailyForecasts(locationKey).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.data; }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var addToFavorites = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Favorites] add to Favorites', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var removeFromFavorites = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Favorites] Remove From to Favorites', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var setSelectedFavorite = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Favorites] Set Selected Favorite', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
            var getWeatherAutocomplete = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Weather Autocomplete Weather', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getWeatherAutocompleteSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Weather Autocomplete Weather Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var setWeatherAutocomplete = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] set Weather Autocomplete', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getWeatherAutocompleteFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Weather Autocomplete Weather Failure', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getCurrentSelectedPlaceWeather = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Current Selected Place Weather', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getCurrentSelectedPlaceWeatherSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Current Selected Place Weather Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var setCurrentSelectedPlaceWeather = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] set Current Selected Place Weather', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getCurrentSelectedPlaceWeatherFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Current Selected Place Weather Failure', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getFiveDailyWeatherForecasts = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Five Daily Weather Forecasts', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getFiveDailyWeatherForecastsSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Five Daily Weather Forecasts Success', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var setFiveDailyWeatherForecasts = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] set Five Daily Weather Forecasts', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var getFiveDailyWeatherForecastsFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] Get Five Daily Weather Forecasts Failure', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var setAutocompleteSelectedValue = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] set Autocomplete Selected Value', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            var setCurrentCityExistInFavoriteList = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Weather] set Current City Exist In Favorites List', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FavoritesEffects = /** @class */ (function () {
                function FavoritesEffects(actions$, weatherApiService) {
                    this.actions$ = actions$;
                    this.weatherApiService = weatherApiService;
                }
                return FavoritesEffects;
            }());
            FavoritesEffects.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WeatherEffects = /** @class */ (function () {
                function WeatherEffects(actions$, weatherApiService) {
                    var _this = this;
                    this.actions$ = actions$;
                    this.weatherApiService = weatherApiService;
                    this.getWeatherAutocomplete$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getWeatherAutocomplete"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (action) {
                        return _this.weatherApiService.getAutocompleteResults(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getWeatherAutocompleteFailure"]({ error: err })); }));
                    ...
                    this.getWeatherAutocompleteSuccess$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getWeatherAutocompleteSuccess"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return _actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["setWeatherAutocomplete"](data); }));
                    this.setCurrentSelectedPlaceWeather$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getCurrentSelectedPlaceWeather"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (action) {
                        return _this.weatherApiService.getCurrentSelectedPlaceForecast(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getCurrentSelectedPlaceWeatherFailure"]({ error: err })); }));
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
                    ...
                    this.getCurrentSelectedPlaceWeatherSuccess$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getCurrentSelectedPlaceWeatherSuccess"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) { return _actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["setCurrentSelectedPlaceWeather"](data); }));
                    this.getFiveDailyWeatherForecasts$ = this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getFiveDailyWeatherForecasts"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (action) {
                        return _this.weatherApiService.get5DaysOfDailyForecasts(action.data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_5__["getFiveDailyWeatherForecastsFailure"]({ error: err })); }));
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var favoritesFeatureKey = 'favorites';
            var favInitialState = {
                favoritesArray: [],
                selectedFavorite: null
            };
            var favoritesReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(favInitialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_favorites_actions__WEBPACK_IMPORTED_MODULE_2__["setSelectedFavorite"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { selectedFavorite: data }));
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_favorites_actions__WEBPACK_IMPORTED_MODULE_2__["addToFavorites"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { favoritesArray: state.favoritesArray.concat([data]) }));
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_favorites_actions__WEBPACK_IMPORTED_MODULE_2__["setSelectedFavorite"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { selectedFavorite: data }));
            }));
            function reducer(state, action) {
                if (state === void 0) { state = favInitialState; }
                return favoritesReducer(state, action);
            }
            var getFavoritesArray = function (state) { return state.favoritesArray; };
            var getSelectedFavorite = function (state) { return state.selectedFavorite; };
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var selectWeatherState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])(_weather_reducer__WEBPACK_IMPORTED_MODULE_3__["weatherFeatureKey"]);
            var getAutocompleteResults = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectWeatherState, _weather_reducer__WEBPACK_IMPORTED_MODULE_3__["getAutocompleteResults"]);
            var getCurrentSelectedData = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectWeatherState, _weather_reducer__WEBPACK_IMPORTED_MODULE_3__["getCurrentSelectedData"]);
            var getFiveDaysForecast = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectWeatherState, _weather_reducer__WEBPACK_IMPORTED_MODULE_3__["getFiveDaysForecast"]);
            var getAutocompleteSelected = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectWeatherState, _weather_reducer__WEBPACK_IMPORTED_MODULE_3__["getAutocompleteSelectedValue"]);
            var getIsCurrentCityExistInFavoriteList = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectWeatherState, _weather_reducer__WEBPACK_IMPORTED_MODULE_3__["getIsCurrentCityExistInFavoriteList"]);
            var selectFavoritesState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createFeatureSelector"])(_favorites_reducer__WEBPACK_IMPORTED_MODULE_4__["favoritesFeatureKey"]);
            var getSelectedFavorite = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectFavoritesState, _favorites_reducer__WEBPACK_IMPORTED_MODULE_4__["getSelectedFavorite"]);
            var getFavoritesArray = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createSelector"])(selectFavoritesState, _favorites_reducer__WEBPACK_IMPORTED_MODULE_4__["getFavoritesArray"]);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var weatherReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_2__["setWeatherAutocomplete"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { autocompleteResults: data }));
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_2__["setCurrentSelectedPlaceWeather"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { currentSelectedData: data }));
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_2__["setFiveDailyWeatherForecasts"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { fiveDaysForecast: data }));
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_2__["setAutocompleteSelectedValue"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { autocompleteSelectedValue: data }));
            }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_weather_actions__WEBPACK_IMPORTED_MODULE_2__["setCurrentCityExistInFavoriteList"], function (state, _a) {
                var data = _a.data;
                return (Object.assign({}, state, { isCurrentCityExistInFavoriteList: data }));
            }));
            function reducer(state, action) {
                if (state === void 0) { state = initialState; }
                return weatherReducer(state, action);
            }
            var getAutocompleteSelectedValue = function (state) { return state.autocompleteSelectedValue; };
            var getAutocompleteResults = function (state) { return state.autocompleteResults; };
            var getCurrentSelectedData = function (state) { return state.currentSelectedData; };
            var getFiveDaysForecast = function (state) { return state.fiveDaysForecast; };
            var getIsCurrentCityExistInFavoriteList = function (state) { return state.isCurrentCityExistInFavoriteList; };
            /***/ 
        }),
