(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["favorites-favorites-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FavoritesContainerComponent = /** @class */ (function () {
                function FavoritesContainerComponent(store, router) {
                    this.store = store;
                    this.router = router;
                    this.iconsGeneratorFunc = _shared_services_util_service__WEBPACK_IMPORTED_MODULE_5__["iconsGeneratorFunc"];
                }
                FavoritesContainerComponent.prototype.ngOnInit = function () {
                    this.favoritesArray$ = this.store.select(_store_reducers__WEBPACK_IMPORTED_MODULE_3__["getFavoritesArray"]);
                };
                FavoritesContainerComponent.prototype.favoriteClicked = function (fav) {
            ...
            FavoritesContainerComponent.ctorParameters = function () { return [
